...
def create_test_list():
    ...
    with open(r'WLASL-Recognition-and-Translation\WLASL\I3D\preprocess\wlasl_2000_list.txt') as file:
        for line in file:
...
def create_WLASL_dictionary():
    ...
    with open(r"E:\personalProjects\New folder\WLASL-Recognition-and-Translation\WLASL\I3D\preprocess\wlasl_class_list.txt") as file:
        for line in file:
            split_list = line.split()
            if len(split_list) != 2:
